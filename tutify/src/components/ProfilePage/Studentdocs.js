                            ...
                            filesViewTutors.map((file, index) => {
                              ...
                              return (
                                <TableRow key={index}>
                                  ...
                                  <td>{uploadDate}</td>
                                  <td align="center"><Button type="button" variant="contained" className="submit" size="small" onClick={() => window.location.replace(link)} id={file._id}><GetAppIcon /></Button></td>
                            ...
                            files.map((file, index) => {
                              ...
                              return (
                                <TableRow key={index}>
                                  ...
                                  <TableCell align="center"><Fab type="button" variant="extended" aria-label="add" fontSize="small" onClick={() => window.location.replace(link)} id={file._id}><GetAppIcon fontSize="small" style={{ width: '20px', height: '20px' }} /></Fab></TableCell>
                                </TableRow>
                              )
                            })
                          }
